...
urlpatterns = [
    ...
    path('avaliacoes/', AvaliacoesAPIView.as_view(), name='avalicoes'),
    ...
    path('avaliacoes/<int:avaliacao_pk>/', AvaliacaoAPIView.as_view(), name='avaliacao'),  # tem que colocar a pk porque ele pega somente esse PK
]
